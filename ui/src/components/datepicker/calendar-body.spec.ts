...
function createCell(value: number, cellClasses?: OuiCalendarCellCssClasses) {
...
describe('OuiCalendarBody', () => {
  ...
  describe('standard calendar body', () => {
    ...
    function refreshElementLists() {
      ...
      labelEls = Array.from(
        calendarBodyNativeElement.querySelectorAll('.oui-calendar-body-label')
      );
      cellEls = Array.from(
        calendarBodyNativeElement.querySelectorAll('.oui-calendar-body-cell')
      );
    }
    ...
    it('should mark active date', () => {
      ...
      expect(cellEls[10].classList).toContain('oui-calendar-body-active');
    });
