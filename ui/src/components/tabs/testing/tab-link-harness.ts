...
/** Harness for interacting with an MDC-based Angular Ouierial tab link in tests. */
export class OuiTabLinkHarness extends ComponentHarness {
  /** The selector for the host element of a `OuiTabLink` instance. */
  static hostSelector = '.oui-mdc-tab-link';
   ...
   */
  static with<T extends OuiTabLinkHarness>(
  ...
  async isDisabled(): Promise<boolean> {
    const host = await this.host();
    return host.hasClass('oui-mdc-tab-disabled');
  }
