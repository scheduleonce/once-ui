...
/** Harness for interacting with a standard oui-tab-nav-panel in tests. */
export class OuiTabNavPanelHarness extends ContentContainerComponentHarness {
  /** The selector for the host element of a `OuiTabNavPanel` instance. */
  static hostSelector = '.oui-mdc-tab-nav-panel';
   ...
   */
  static with<T extends OuiTabNavPanelHarness>(
