...
/** Harness for interacting with an MDC_based Angular Ouierial tab in tests. */
export class OuiTabHarness extends ContentContainerComponentHarness<string> {
  /** The selector for the host element of a `OuiTab` instance. */
  static hostSelector = '.oui-mdc-tab';
   ...
   */
  static with<T extends OuiTabHarness>(
