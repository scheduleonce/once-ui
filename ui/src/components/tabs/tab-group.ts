...
/**
 * Base class with all of the `OuiTabGroupBase` functionality.
 * @docs-private
 */
@Directive()
  ...
  implements AfterContentInit, AfterContentChecked, OnDestroy, CanColor, CanDisableRipple
{
   ...
   */
  abstract _allTabs: QueryList<OuiTab>;
  abstract _tabBodyWrapper: ElementRef;
  abstract _tabHeader: OuiTabGroupBaseHeader;
  ...
  set backgroundColor(value: ThemePalette) {
    ...
    nativeElement.classList.remove(`oui-background-${this.backgroundColor}`);

    if (value) {
      nativeElement.classList.add(`oui-background-${value}`);
    }
  ...
  ngAfterContentChecked() {
    ...
    if (this._selectedIndex != indexToSelect) {
      ...
      if (!isFirstRun) {
        ...
        // Fixes https://stackblitz.com/edit/oui-tabs-scroll-page-top-on-tab-change
  ...
  _getTabIndex(tab: OuiTab, index: number): number | null {
    if (tab.disabled) {
      return null;
    }
...
/**
 * Ouierial design tab-group component. Supports basic tab pairs (label + content) and includes
