...
export class OuiTabBodyPortal extends CdkPortalOutlet implements OnInit, OnDestroy {
 ...
 */
@Directive()
export abstract class _OuiTabBodyBase implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    // Ensure that we get unique animation events, because the `.done` callback can ge
  }
...
export class OuiTabBody extends _OuiTabBodyBase {
