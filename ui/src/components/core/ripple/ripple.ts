...
export const OUI_RIPPLE_GLOBAL_OPTIONS = new InjectionToken<RippleGlobalOptions>(
...
export class OuiRipple implements OnInit, OnDestroy, RippleTarget {
   ...
   * bounding rectangle.
   */
  @Input('ouiRippleRadius') radius: number = 0;
  ...
  constructor(
    ...
    ngZone: NgZone,
    platform: Platform,
    @Optional() @Inject(OUI_RIPPLE_GLOBAL_OPTIONS) globalOptions?: RippleGlobalOptions,
